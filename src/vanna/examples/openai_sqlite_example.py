...
async def main() -> None:
    ...
    # print("\n" + "=" * 60)
    # print("SQLite Database Assistant Demo")
    # print("=" * 60)
    # print("This demo shows openai querying the Chinook music database.")
    # print("OpenAI will intelligently construct SQL queries to answer questions")
